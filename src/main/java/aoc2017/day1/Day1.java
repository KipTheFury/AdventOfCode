...
public class Day1 {
    ...
    private static final Logger log = LoggerFactory.getLogger("2017 - Day 1");
    ...
    public static void main(String[] args) {
        ...
        int part1 = parser.parseCaptcha(input, 1);
        log.info("Part 1 - Captcha Sum [{}]", part1);

        int part2 = parser.parseCaptcha(input, input.length() / 2);
        log.info("Part 2  - Captcha Sum [{}]", part2);
    }
}
