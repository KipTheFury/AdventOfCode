...
public class Day6 {
    ...
    private static final Logger log = LoggerFactory.getLogger("2019 - Day 6");

    public static void main(String[] args) {

        String[] orbits = FileUtils.getLinesAsArray("src/main/resources/2019/day6-orbits");

        OrbitMapper mapper = new OrbitMapper();
        mapper.mapOrbits(orbits);

        int totalOrbitCount = mapper.getTotalOrbitCount();
        log.info("Part 1 - Total Orbit Count [{}]", totalOrbitCount);

        int shortestPath = mapper.getShortestPathBetweenPlanets("YOU", "SAN");
        log.info("Part 1 - Shortest path between YOU and SAN [{}]", shortestPath);
