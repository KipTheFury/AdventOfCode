 ...
 * tiny-code-displaying-screen market. That's what the advertisement on the back of the display tries to convince
 * you, anyway.
 * <p>
...
public class Day8 {
    ...
    private static final Logger log = LoggerFactory.getLogger("2016 - Day 8");

    public static void main(String[] args) {

        String[] instructions = FileUtils.getLinesAsArray("src/main/resources/2016/day8-instructions");

        PixelController pixels = new PixelController();

        pixels.parseInstructions(instructions);

        log.info("Part 1 - Active Pixels [{}]", pixels.getActivePixels());
