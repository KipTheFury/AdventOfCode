...
public class Day1 {
    ...
    private static final Logger log = LoggerFactory.getLogger("2016 - Day 1");

    public static void main(String[] args) {

        String directionString = FileUtils.getLinesAsArray("src/main/resources/2016/day1-directions")[0];
        String[] directions = directionString.split(", ");

        BunnyHQFinder finder = new BunnyHQFinder();

        int part1 = finder.calculateDistanceToBunnyHQ(directions);
        log.info("Part 1 - Steps to Bunny HQ [{}]", part1);

        int part2 = finder.distanceToClosestRepeatedLocation(directions);
        log.info("part 2 - Steps to first Repeated Location [{}]", part2);
    }
}
