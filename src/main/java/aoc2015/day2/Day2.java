...
public class Day2 {
    ...
    private static final Logger log = LoggerFactory.getLogger("2015 - Day 2");

    public static void main(String[] args) {

        String[] presents = FileUtils.getLinesAsArray("src/main/resources/2015/day2-presents");
        ...
        log.info("Part 1 - total wrapping required [{}]", materials.getValue0());
        log.info("Part 2 - Total Ribbon required [{}]", materials.getValue1());
    }
}
